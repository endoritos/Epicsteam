 ...
 */
final class Version20240215105904 extends AbstractMigration
{
    ...
    {
        // Create user_game table if it doesn't exist
        $this->addSql('CREATE TABLE user_game (
            user_id INT NOT NULL,
            game_id INT NOT NULL,
            INDEX IDX_8A2F7F13772E836AF396750CCC410E5 (user_id),
            INDEX IDX_8A2F7F134584665A (game_id),
            PRIMARY KEY(user_id, game_id),
            CONSTRAINT FK_8A2F7F13772E836AF396750CCC410E5 FOREIGN KEY (user_id) REFERENCES user (id),
            CONSTRAINT FK_8A2F7F134584665A FOREIGN KEY (game_id) REFERENCES game (id)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD gamename VARCHAR(255) NOT NULL, ADD gameapi VARCHAR(255) NOT NULL, DROP user_id, DROP game_name, DROP game_api, DROP image_path');
    }
}
